    ...
    <div class="container">    
      ...
      <div>
      	<form class="form-horizontal">
				  ...
				  <div class="form-group">
				    <label for="newUserName" class="col-sm-2 control-label">User Name</label>
				    <div class="col-sm-10">
				      <input type="text" class="form-control" id="newUserName" placeholder="Example: James,Eva,Jason">
				    </div>
				  </div>
